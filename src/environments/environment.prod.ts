export let environment = {
  ...
  basemaps: [
    ...
    },
    {
      ...
      styling: 'https://sgx.geodatenzentrum.de/gdz_basemapde_vektor/styles/bm_web_col.json',
      topPlusBg: true,
      topPlusBgBehind: 'Hintergrund',
      useMetaData: false,
      isBeta: false
    },
    {
      ...
      styling: 'https://sgx.geodatenzentrum.de/gdz_basemapde_vektor/styles/bm_web_gry.json',
      topPlusBg: true,
      topPlusBgBehind: 'Hintergrund',
      useMetaData: false,
      isBeta: false
    ...
    },
    {
      ...
      styling: 'https://basemap.de/data/produkte/web_raster_schummerung/styles/bm_viewer_schummerung.json',
      topPlusBg: true,
